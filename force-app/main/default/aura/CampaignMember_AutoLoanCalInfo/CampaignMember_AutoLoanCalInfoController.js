({
    onInit: function (component, event, helper) {
        ...
        var ThirdSection = ['RTL_AL_Refer_No_'+proNum+'__c','RTL_AL_Req_No1_'+proNum+'__c','RTL_Reason_Lost__c','RTL_AL_Req_No2_'+proNum+'__c','Corebank_Emp_Name_'+proNum+'__c','Corebank_Emp_Phone_No_'+proNum+'__c','RTL_Hub_Code_'+proNum+'__c','RTL_Hub_Name_'+proNum+'__c','HPAP_Status_Code_1__c','RTL_Status_1__c','Details_of_Status_1__c','HPAP_Reason_Code_1__c','HPAP_Reason_Description_1__c','RTL_Status_Approve_1__c','RTL_Refer_Date_1__c','RTL_Submit_Date_1__c']
