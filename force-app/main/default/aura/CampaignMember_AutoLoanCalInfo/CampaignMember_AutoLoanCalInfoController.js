({
    onInit: function (component, event, helper) {
        ...
        var ThirdSection = ['RTL_AL_Refer_No_'+proNum+'__c','RTL_AL_Req_No1_'+proNum+'__c','RTL_Reason_Lost__c','RTL_AL_Req_No2_'+proNum+'__c','Corebank_Emp_Name_'+proNum+'__c','Corebank_Emp_Phone_No_'+proNum+'__c','RTL_Hub_Code_'+proNum+'__c','RTL_Hub_Name_'+proNum+'__c','HPAP_Status_Code_'+proNum+'__c','RTL_Status_'+proNum+'__c','Details_of_Status_'+proNum+'__c','HPAP_Reason_Code_'+proNum+'__c','HPAP_Reason_Description_'+proNum+'__c','HPAP_Status_Approve_'+proNum+'__c','HPAP_Refer_Date_'+proNum+'__c','HPAP_Request_date_'+proNum+'__c']
